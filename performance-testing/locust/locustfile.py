...
class DataGenerator:
    ...
    def generate_patient():
        ...
        return {
            ...
            "date_of_birth": (datetime.now() - timedelta(days=random.randint(365, 36500))).isoformat(),
            ...
            "insurance_provider": random.choice(["Blue Cross", "Aetna", "United Health", "Kaiser"]),
            "medical_history": {
                "allergies": random.choice([[], ["Penicillin"], ["Peanuts"], ["Latex"]]),
                "conditions": random.choice([[], ["Diabetes"], ["Hypertension"], ["Asthma"]])
            }
        }
    ...
    def generate_appointment():
        ...
        return {
            ...
            "appointment_type": random.choice(["Checkup", "Consultation", "Follow-up", "Emergency"]),
            "status": "scheduled",
    ...
    def generate_social_post():
        ...
        return {
            ...
            "content": f"Post content {uuid.uuid4().hex} " + " ".join([f"word{i}" for i in range(random.randint(5, 50))]),
...
class ClinicUser(BaseUser):
    ...
    def get_patients(self):
        ...
        with self.client.get("/api/clinic/patients",
    ...
    def create_patient(self):
        ...
        with self.client.post("/api/clinic/patients",
                             json=patient_data,
                             headers=self.headers,
                             catch_response=True) as response:
    ...
    def get_patient_details(self):
        ...
        with self.client.get(f"/api/clinic/patients/{patient_id}",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
                ...
                response.failure(f"Failed to get patient {patient_id}: {response.status_code}")
    ...
    def create_appointment(self):
        ...
        with self.client.post("/api/clinic/appointments",
            ...
            if response.status_code in [200, 201]:
                ...
                response.failure(f"Failed to create appointment: {response.status_code}")
    ...
    def update_appointment(self):
        ...
        with self.client.patch(f"/api/clinic/appointments/{appointment_id}",
            ...
            if response.status_code in [200, 204]:
                ...
                response.failure(f"Failed to update appointment: {response.status_code}")
...
class EcommerceUser(BaseUser):
    ...
    def browse_products(self):
        ...
        with self.client.get(f"/api/ecommerce/products?category={category}",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
    ...
    def search_products(self):
        ...
        with self.client.get(f"/api/ecommerce/search?q={query}",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
    ...
    def add_to_cart(self):
        ...
        with self.client.post("/api/ecommerce/cart",
                             json=cart_item,
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 201]:
    ...
    def create_order(self):
        ...
        with self.client.post("/api/ecommerce/orders",
                             json=order_data,
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 201]:
    ...
    def get_order_status(self):
        ...
        with self.client.get(f"/api/ecommerce/orders/{order_id}",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
...
class IoTUser(BaseUser):
    ...
    def send_reading(self):
        ...
        with self.client.post("/api/iot/readings",
                             json=reading_data,
                             headers=self.headers,
                             catch_response=True) as response:
    ...
    def send_batch_readings(self):
        ...
        readings = [DataGenerator.generate_iot_reading() for _ in range(random.randint(10, 50))]

        with self.client.post("/api/iot/readings/batch",
            ...
            if response.status_code in [200, 201, 204]:
                ...
                response.failure(f"Failed to send batch readings: {response.status_code}")
    ...
    def get_device_status(self):
        ...
        with self.client.get(f"/api/iot/devices/{device_id}/status",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
    ...
    def get_device_history(self):
        ...
        with self.client.get(f"/api/iot/devices/{device_id}/history?hours=24",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
                ...
                response.failure(f"Failed to get device history: {response.status_code}")
...
class SocialMediaUser(BaseUser):
    ...
    def get_feed(self):
        """Get user feed"""
        with self.client.get("/api/social/feed",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
    ...
    def create_post(self):
        ...
        with self.client.post("/api/social/posts",
                             json=post_data,
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 201]:
    ...
    def like_post(self):
        ...
        with self.client.post(f"/api/social/posts/{post_id}/like",
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 201, 204]:
                response.success()
    ...
    def comment_on_post(self):
        ...
        with self.client.post(f"/api/social/posts/{post_id}/comments",
                             json=comment,
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 201]:
    ...
    def get_profile(self):
        ...
        with self.client.get(f"/api/social/users/{user_id}",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
...
class AdminUser(BaseUser):
    ...
    def get_dashboard_metrics(self):
        ...
        with self.client.get("/api/admin/metrics/dashboard",
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code == 200:
                response.success()
    ...
    def update_configuration(self):
        ...
        with self.client.put("/api/admin/config",
                            json=config,
                            headers=self.headers,
                            catch_response=True) as response:
            if response.status_code in [200, 204]:
    ...
    def trigger_backup(self):
        ...
        with self.client.post("/api/admin/backup/trigger",
                             headers=self.headers,
                             catch_response=True) as response:
            if response.status_code in [200, 202]:
                response.success()
