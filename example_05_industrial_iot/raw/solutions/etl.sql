...
INSERT INTO fact_machine_feed (sensor_id, source_row_id, factory_name, line_name, machine_code, reading_time, reading_value, unit, operator_name, work_order_code)
SELECT
    d_sensor.sensor_id,
    r.row_id,
    r.factory_name,
