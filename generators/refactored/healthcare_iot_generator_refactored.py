#!/usr/bin/env python3
"""
HealthcareIoTGenerator - Refactored with BaseGenerator
...
class HealthcareIoTGenerator(BaseGenerator):
    """Refactored HealthcareIoTGenerator using BaseGenerator infrastructure"""
