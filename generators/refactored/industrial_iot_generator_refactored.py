#!/usr/bin/env python3
"""
IndustrialIoTGenerator - Refactored with BaseGenerator
...
class IndustrialIoTGenerator(BaseGenerator):
    """Refactored IndustrialIoTGenerator using BaseGenerator infrastructure"""
