#!/usr/bin/env python3
"""
EducationDataGenerator - Refactored with BaseGenerator
...
class EducationDataGenerator(BaseGenerator):
    """Refactored EducationDataGenerator using BaseGenerator infrastructure"""
