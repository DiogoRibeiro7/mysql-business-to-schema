...
class RemainingSchemaGenerator:
    ...
    def generate_fleet_management_data(self, count: int = 100):
        ...
        print(
            f"  Created: {output_file} ({count} vehicles, {count//2} drivers, {count*3} trips)"
        )
        return output_file
    ...
    def generate_healthcare_iot_data(self, count: int = 100):
        ...
        print(
            f"  Created: {output_file} ({count} patients, {count*2} devices, {count*10} readings)"
        )
        return output_file
    ...
    def generate_streaming_ml_data(self, count: int = 100):
        ...
        print(
            f"  Created: {output_file} (20 streams, {count//5} models, {count*5} predictions)"
        )
        return output_file
    ...
    def generate_cryptocurrency_data(self, count: int = 100):
        ...
        sql_lines.append("\n-- Insert wallets")
        sql_lines.append(
            "INSERT INTO wallets (wallet_address, user_id, created_at, balance_btc, balance_eth, balance_usd) VALUES"
        )
        ...
        sql_lines.append("\n-- Insert transactions")
        sql_lines.append(
            "INSERT INTO transactions (tx_hash, from_wallet, to_wallet, cryptocurrency, amount, fee, status, timestamp) VALUES"
        )
        ...
        print(
            f"  Created: {output_file} (10 cryptos, {count} wallets, {count*3} transactions)"
        )
        return output_file
