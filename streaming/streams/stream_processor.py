...
class StreamProcessor:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.schema_registry_url = config.get('schema_registry_url', 'http://localhost:8081')
    ...
    def initialize(self):
        ...
        try:
            ...
            logger.info(f"Stream processor initialized. Subscribed to: {self.input_topics}")
        ...
        if event.event_type == EventType.INSERT:
            ...
            if customer_id:
                ...
                if customer:
                    ...
                    processed['enrichments']['customer_segment'] = self._get_customer_segment(customer)
        ...
        if event.event_type == EventType.UPDATE:
            ...
            if before.get('price') != after.get('price'):
                price_change = {
                    ...
                    'change_percentage': ((after.get('price', 0) - before.get('price', 0)) / before.get('price', 1)) * 100
                }
    ...
    def _process_transaction_event(self, event: CDCEvent, processed: Dict) -> Dict:
        ...
        if event.event_type == EventType.INSERT:
            ...
            if customer_id:
                ...
                if last_transaction:
                    time_diff = datetime.now() - datetime.fromisoformat(last_transaction['timestamp'])
